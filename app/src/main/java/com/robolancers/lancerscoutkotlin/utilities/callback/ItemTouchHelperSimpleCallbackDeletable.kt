...
class ItemTouchHelperSimpleCallbackDeletable(context: Context, val adapter: Deletable) {
...
class ItemTouchHelperSimpleCallbackReorderable(val adapter: Reorderable) {
    val simpleItemCallback = object : ItemTouchHelper.SimpleCallback(
